...
TO DO:
- More testing!
- Have a bash shell script wrapper which: 
  - Asserts you are root
  - Creates/mounts a swap space in memory under /tmpfs or /ramfs
  - Calls 'Driver.py' with this mounted RAM-based swap buffer.
